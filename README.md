...
Built a Python machine-learning pipeline to classify stellar variability from TESS light curves, converted official MAST mission data into a curated training set, compared baseline classifiers, and deployed a Streamlit app for interactive prediction and dataset inspection.

## Good Interview Talking Points

- Why engineered features were chosen before deep learning
- Why the current dataset is intentionally small
- How the pipeline separates synthetic testing from real-data workflows
- How the manifest and dataset summary make the project easier to maintain
- What you would do next if you expanded the dataset

There is a short companion doc with that framing in [docs/PROJECT_OVERVIEW.md](c:\Users\Admin\Desktop\repos\tess-variable-star-classifier\docs\PROJECT_OVERVIEW.md).

## Next Improvements

1. Expand the official TESS subset from 8 files to 30-100 files.
2. Add an exploratory notebook with class plots and error analysis.
3. Compare engineered-feature models against a small 1D CNN.
4. Add confusion matrices and misclassification review.
5. Package the app for easier public demo deployment.
